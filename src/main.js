...
main.make = function (options) {
    var canvasId = options.canvas;
    var blocks = options.mapData;
    var shouldSortBlocks = true;
    var shouldDrawAxes = true;
    var axisLen = 12;
    var silhouette = true;
    ...
    var camera = new isoCamera(origin, scale);
    var painter = new isoPainter(camera);
